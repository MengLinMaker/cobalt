...
export default async function (o) {
  ...
  if ((!bestQuality && !o.isAudioOnly) || !hasAudio) return { error: 'youtube.codec' }
  ...
  if (o.dubLang) {
    const dubbedAudio = adaptive_formats.find(
      (i) => checkBestAudio(i) && i.language === o.dubLang && i.audio_track,
    )
