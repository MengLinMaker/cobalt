...
export const apiSchema = z
  .object({
    ...
    audioBitrate: z.enum(['320', '256', '128', '96', '64', '8']).default('128'),

    audioFormat: z.enum(['best', 'mp3', 'ogg', 'wav', 'opus']).default('mp3'),

    downloadMode: z.enum(['auto', 'audio', 'mute']).default('auto'),

    filenameStyle: z.enum(['classic', 'pretty', 'basic', 'nerdy']).default('classic'),

    youtubeVideoCodec: z.enum(['h264', 'av1', 'vp9']).default('h264'),
